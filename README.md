...
In short, while the original project may work on it's own, this version
is designed to play nice with frameworks such as Symfony and Laravel.

**The requirement to use config.php in the web root has been completely removed.** 

Instead, see the updated $params array fields when instantiating the ET_Client.
